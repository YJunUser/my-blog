...
export default {
  ...
  mounted() {
    ...
    console.log(navtab, navtabItems)
...
.navtab {
  --navtab-width: 20rem;
  --navtab-item-width: calc(var(--navtab-width) / 4 - 1.2rem);
  --navtab-overlay-width: calc(var(--navtab-item-width) + 3rem);
  --active-index: 0;
