<template>
  <div class="nav-bar">
    <nav class="navtab">
      <ul>
        <nav-bar-item path="/home" active-index="0">
          <template v-slot:img>
        ...
        <nav-bar-item path="/text" active-index="1">
          <template v-slot:img>
        ...
        <nav-bar-item path="/collection" active-index="2">
          <template v-slot:img>
        ...
        <nav-bar-item path="/help" active-index="3">
          <template v-slot:img>
